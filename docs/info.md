...
**Description:** Does nothing. M and N remain unchanged.
...
**Description:**  
If B == D, M takes the value of A; otherwise, M takes the value of C. N takes the value of D.
...
**Description:**  
Computes the Manhattan Distance (|A - C| + |B - D|) for M. N represents a direction.
...
**Description:**  
M stores the area |(A-C)| * |(B-D)|.  
N stores the perimeter 2*|(A-C)| + 2*|(B-D)|.
...
**Description:**  
Computes the mean of 3 values across a row.
...
**Description:**  
Computes the sum of 3 values across a row.
